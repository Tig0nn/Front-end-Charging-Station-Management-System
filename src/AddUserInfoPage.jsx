                ...
                <Form className="form-container" onSubmit={handleSubmitForm}>
                    ...
                    <Form.Group className="mb-3" controlId="form-user-fullname">
                        ...
                        <div className="fullname">
                            <Form.Control onFocus={handleFocus} onChange={handleChangeValue} style={{
                            ...
                            }} onFocus={handleFocus} onChange={handleChangeValue} name="first_name" className="first-name" type="text" placeholder="Tên" />
                        </div>
                        {/* Hiển thị lỗi */}
                    ...
                    <Form.Group className="mb-3" controlId="form-user-gender">
                        ...
                        <div>
                            <Form.Check onFocus={handleFocus} onChange={handleChangeValue} className="form-radio" inline label="Nam" name="gender" type="radio" id="gender-nam" value="0" />
                            <Form.Check onFocus={handleFocus} onChange={handleChangeValue} className="form-radio" inline label="Nữ" name="gender" type="radio" id="gender-nu" value="1" />
                        </div>
                        {/* Hiển thị lỗi */}
                        {(errors.gender) && (
                            <div style={{ color: 'red', marginTop: '4px' }}>
                    ...
                    <Form.Group className="mb-3" controlId="form-user-dob">
                        ...
                        }} onFocus={handleFocus} onChange={handleChangeValue} name="dob" className="placeholdertxt" lang="vi" type="date" />
                        {/* Hiển thị lỗi */}
                        {(errors.dob) && (
                            <div style={{ color: 'red', marginTop: '4px' }}>
                                {(errors.dob)}
                    ...
                    <Form.Group className="mb-3" controlId="form-user-phoneNum">
                        ...
                        }} onFocus={handleFocus} onChange={handleChangeValue} name="phoneNum" className="placeholdertxt" type="text" placeholder="+84-XXX-XXX-XXX" />
                        {/* Hiển thị lỗi */}
                        {(errors.phoneNum) && (
                            <div style={{ color: 'red', marginTop: '4px' }}>
                                {(errors.phoneNum)}
                    ...
                    <div className="form-check">
                        <input className="form-check-input" type="checkbox" onChange={handleAgree} />
                        <label className="form-check-label">Tôi xin cam đoan mọi thông tin trên đều chuẩn xác.</label>
                    </div>

                    <Button variant="primary" type="submit" disabled={!agree||isSubmitting}>
